...
class PFLocaliser(PFLocaliserBase):
    ...
    def initialise_particle_cloud(self, initialpose):
        ...
        noise_x = np.random.normal(0,initialpose.pose.covariance[0]+10,NUMBER_OF_PARTICLES)
        noise_y = np.random.normal(0,initialpose.pose.covariance[7]+10,NUMBER_OF_PARTICLES)
    ...
    def update_particle_cloud(self, scan):
        ...
        for particle in self.particlecloud.poses:
            weighted_poses.append([particle, self.sensor_model.get_weight(scan, particle)])
