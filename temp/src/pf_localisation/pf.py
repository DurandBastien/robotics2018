...
class PFLocaliser(PFLocaliserBase):
    ...
    def initialise_particle_cloud(self, initialpose):
        ...
        rospy.loginfo("commencing cloud init loop")
        for ith_particule in range(NUMBER_OF_PARTICLES):
            ...
            rospy.loginfo("new particle made")
    ...
    def update_particle_cloud(self, scan):
        ...
        weighted_poses = []
        rospy.loginfo("entering update particle filter in pf.py")
	...
	n = len(weighted_poses)
        ...
        rospy.loginfo("commencing resample")
